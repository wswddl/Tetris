...
public class MinoZ extends Mino {
    public static final int MINO_Z_NEXT_PIXEL_X = NEXT_BOX_HEIGHT_WIDTH / 2;
    public static final int MINO_Z_NEXT_PIXEL_Y = NEXT_BOX_HEIGHT_WIDTH / 2;
    public MinoZ() {
        super();
        create(Color.RED);
    }
    ...
    public void setNextAndHoldBoxPosition() {
        ...
        int deltaY = 0;
        blocks[0].setRectangleCoor(MINO_Z_NEXT_PIXEL_X + deltaX,
                MINO_Z_NEXT_PIXEL_Y + deltaY);
        blocks[1].setRectangleCoor(MINO_Z_NEXT_PIXEL_X + BLOCK_SIZE + deltaX,
                MINO_Z_NEXT_PIXEL_Y + deltaY);
        blocks[2].setRectangleCoor(MINO_Z_NEXT_PIXEL_X + deltaX,
                MINO_Z_NEXT_PIXEL_Y - BLOCK_SIZE + deltaY);
        blocks[3].setRectangleCoor(MINO_Z_NEXT_PIXEL_X - BLOCK_SIZE + deltaX,
                MINO_Z_NEXT_PIXEL_Y - BLOCK_SIZE + deltaY);
